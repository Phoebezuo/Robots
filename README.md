...
A large group of angry robots are chasing you, as the sole survivor of the robocolypse, must survive to warn the others. You have a scanner which can detect robots within the landscape, however don't let them get too close or human kind as we know will cease to exist! Try to trick them and get to the exit.

Enough with the glamourous introduction, you are to write a program that will have a defined number of robots placed (however they must be placed at least 2 spaces away from the human).
